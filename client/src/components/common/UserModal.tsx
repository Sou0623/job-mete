      ...
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 id="user-modal-title" className="text-2xl font-bold text-gray-900">アカウント設定</h2>
            <button
              onClick={onClose}
              aria-label="モーダルを閉じる"
          ...
          <div className="flex flex-col items-center text-center pb-6 border-b border-gray-200">
            ...
            <div className="relative mb-4">
              ...
              {user?.photoURL ? (
                ...
                <div
                  className={`w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center border-4 border-blue-200 ${
            ...
            {isEditing ? (
              <div className="w-full max-w-xs">
                <input
                  ...
                  placeholder="表示名を入力"
                  aria-label="表示名"
                  className="w-full text-xl font-bold text-gray-900 text-center border-2 border-blue-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            ) : (
